...
Я работаю в группе разработки мобильных приложений iOS  Сегодня мы с вами обсудим разработку под мобильную платформу iOS и обсудим первые шаги и с чего стоит начать
...
Чаще всего многие используют просто viewDidLoad
Как входную точку.  но важно понимать что именно происходит с контроллером
